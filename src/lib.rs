...
/// Re-export
pub use stm32f767_hal as hal;

use hal::stm32f7x7::{Interrupt, ETHERNET_DMA, ETHERNET_MAC, NVIC};
/// Re-export
pub use stm32f767_hal::stm32f7x7;
...
///
/// * Via the [`Eth`](struct.Eth.html) driver instance that your interrupt
/// handler has access to. * By unsafely getting `Peripherals`.
///
